...
interface RPandeycoin is IERC20 {
...
contract BridgeETH is Ownable {
    ...
    function burn(RPandeycoin _tokenAddress, uint256 _amount) public {
        require(address(_tokenAddress) == tokenAddress);
        _tokenAddress.burn(msg.sender, _amount);
        emit Burn(msg.sender, _amount);
    }

    function withdraw(RPandeycoin _tokenAddress, uint256 _amount) public {
